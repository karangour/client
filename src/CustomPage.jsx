...
const CustomPage = () => {
  ...
  const userData = {
    ...
    // orgName,orgType,userPosition - in a real-life scenario, these will be filled by an API call to Linkedin using userData.linkedin (the user's linkedin profile link). We are hard-coding it for this example.//
    orgName: location.state.linkedin,
    orgType: "retail",
    userPosition: "sales",
  };
